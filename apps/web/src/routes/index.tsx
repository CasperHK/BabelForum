...
// ---------------------------------------------------------------------------
// Types inferred from the Eden Treaty client
// ---------------------------------------------------------------------------
type PostResponse = Awaited<
  ReturnType<typeof client.api.posts.get>
>["data"];

type SinglePost = NonNullable<PostResponse>[number];
...
export default function Home() {
  ...
  const [posts] = createResource(
    ...
    async (filters) => {
      const { data, error } = await client.api.posts.get({ query: filters });
